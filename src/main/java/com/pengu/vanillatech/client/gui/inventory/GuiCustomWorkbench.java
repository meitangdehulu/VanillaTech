...
public class GuiCustomWorkbench extends GuiContainer implements IRecipeShownListener
{
	...
	public GuiCustomWorkbench(InventoryPlayer playerInv, World worldIn)
	{
		this(playerInv, worldIn, BlockPos.ORIGIN);
	}
	
	public GuiCustomWorkbench(InventoryPlayer playerInv, World worldIn, BlockPos blockPosition)
	{
		super(new ContainerCustomWorkbench(playerInv, worldIn, blockPosition));
